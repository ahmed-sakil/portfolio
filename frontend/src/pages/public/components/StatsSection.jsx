    ...
    <section id="stats" className="w-[90%] max-w-7xl mx-auto mb-28 md:mb-36 scroll-mt-28">
      <div className="glass-section rounded-3xl p-8 md:p-14">
        <div className="text-center max-w-2xl mx-auto mb-14">
          <h2 className="text-3xl md:text-5xl font-black tracking-tight mb-4" style={{ color: 'var(--text-primary)' }}>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          {stats?.github && (
            <div
              className="p-6 rounded-2xl border border-white/10 text-center hover:border-accent hover:shadow-[0_0_20px_var(--accent-glow)] transition-all duration-300"
              style={{ backgroundColor: 'var(--bg-surface)' }}
            >
              <div className="w-12 h-12 rounded-xl bg-white/5 border border-white/10 flex items-center justify-center mx-auto mb-4 text-accent">
                <GithubIcon className="w-6 h-6" />
              </div>
              <h3 className="text-xl font-bold mb-2" style={{ color: 'var(--text-primary)' }}>GitHub</h3>
              <p className="text-sm font-medium" style={{ color: 'var(--text-secondary)' }}>
                Repositories: <span className="text-accent font-bold">{stats.github.public_repos}</span>
              </p>
              <p className="text-sm font-medium" style={{ color: 'var(--text-secondary)' }}>
                Followers: <span className="text-accent font-bold">{stats.github.followers}</span>
              </p>
            </div>
          )}
          ...
          {stats?.leetcode && (
            ...
            >
              ...
              <h3 className="text-xl font-bold mb-2" style={{ color: 'var(--text-primary)' }}>LeetCode</h3>
              <p className="text-sm font-medium" style={{ color: 'var(--text-secondary)' }}>
          ...
          {stats?.codeforces && (
            ...
            >
              ...
              <h3 className="text-xl font-bold mb-2" style={{ color: 'var(--text-primary)' }}>Codeforces</h3>
              <p className="text-sm font-medium" style={{ color: 'var(--text-secondary)' }}>
